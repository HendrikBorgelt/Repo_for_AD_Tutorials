...
points_for_outer_shell = [[0, -76.569, 56.569], [0, -76.569, 0]]
points_for_inner_shell = [[0, -75.069, 56.569], [0, -75.069, 0]]
...
mesh3D_outer_circle = go.Scatter3d(x=[i_1[0] for i_1 in points_for_outer_circle], y=[i_1[1] for i_1 in points_for_outer_circle], z=[i_1[2] for i_1 in points_for_outer_circle],
                                mode='lines', line=dict(color='gray', width=plty_linewidth), visible=True, hoverinfo='none', hoverlabel=dict(font_size=font_size))
mesh3d_outer_shell = go.Scatter3d(x=[i_1[0] for i_1 in points_for_outer_shell], y=[i_1[1] for i_1 in points_for_outer_shell], z=[i_1[2] for i_1 in points_for_outer_shell],
                                mode='lines', line=dict(color='gray', width=plty_linewidth), visible=True, hoverinfo='none', hoverlabel=dict(font_size=font_size))
mesh3d_inner_shell = go.Scatter3d(x=[i_1[0] for i_1 in points_for_inner_shell], y=[i_1[1] for i_1 in points_for_inner_shell], z=[i_1[2] for i_1 in points_for_inner_shell],
                                mode='lines', line=dict(color='gray', width=plty_linewidth), visible=True, hoverinfo='none', hoverlabel=dict(font_size=font_size))
...
mesh3D_base_body_3 = go.Mesh3d(x=x_2, y=y_2, z=z_2, i=I_2, j=J_2, k=K_2,
                                 color='lightgray', opacity=0.20, showscale=False, visible=True,
                                    contour=dict(show=True, width=16))
fig_2 = go.Figure(data=[mesh3D_base_body_3, mesh3D_base_body_2, mesh3D_base_body_1,
                        ...
                        mesh3D_inner_circle, mesh3D_outer_circle, mesh3d_outer_shell, mesh3d_inner_shell,
                        ])
fig_2.show()
