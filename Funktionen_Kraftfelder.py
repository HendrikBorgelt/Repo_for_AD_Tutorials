...
def create_mesh3d_for_vectorfeld(mesh_differential_element, scalingfactor, pos_vec, zeta, eta, theta,
                                  plty_linewidth=2, line_color='black', bodycolor='lightgray'):
    ...
    # create vectorfield with plotly cones in range of x, y, z
    np.array([lower_fornt_curve, lower_back_curve, upper_front_curve, upper_back_curve,
                body_front_left, body_front_right, body_back_left, body_back_right,
                body_upper_right, body_upper_left, body_lower_right, body_lower_left])
